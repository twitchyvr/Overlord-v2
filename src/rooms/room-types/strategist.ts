...
export const QUICK_START_TEMPLATES: ReadonlyArray<BuildingTemplate> = [
  {
    ...
    roomConfig: [
      ...
      { floor: 'execution', rooms: ['code-lab', 'testing-lab', 'documentation'] },
    ...
    agentRoster: [
      ...
      { name: 'Documentation Specialist', role: 'documentation_specialist', rooms: ['documentation', 'discovery', 'review'] },
    ],
  ...
  },
  {
    ...
    agentRoster: [
      ...
      { name: 'DevOps Engineer', role: 'operator', rooms: ['deploy'] },
      { name: 'API Documenter', role: 'documentation_specialist', rooms: ['documentation', 'discovery', 'review'] },
    ],
    estimatedPhases: ['discovery', 'architecture', 'execution', 'review', 'deploy'],
  },
  {
